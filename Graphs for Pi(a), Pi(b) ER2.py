...
for Counter in range(AverageNNumber):
    ...
    G = nx.erdos_renyi_graph(n,q, directed=False)
...
plt.savefig('ER2 N=10000 Pi(a) Average Bar', bbox_inches='tight', dpi=300)
...
handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]
plt.legend(handles, labels)
plt.savefig('ER2 N=10000 Pi(b) Average Bar', bbox_inches='tight', dpi=300)
...
handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]
plt.legend(handles, labels)
plt.savefig('ER2 N=10000 Pi(a) Average Line', bbox_inches='tight', dpi=300)
...
handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]
plt.legend(handles, labels)
plt.savefig('ER2 N=10000 Pi(b) Average Line', bbox_inches='tight', dpi=300)
